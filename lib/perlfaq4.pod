...
Starting with Perl v5.46, this construct counts the number of matches
directly. On older Perls, it generates an intermediate list of matches,
counts the elements, and throws the list away, which is less efficient.
